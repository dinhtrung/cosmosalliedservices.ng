...
function kindergarten_social_profile() {
...
function kindergarten_social_share() { 
global $post;
  ?>
...
function kindergarten_custom_excerpt_length( $length ) {
  return 40;
}
add_filter( 'excerpt_length', 'kindergarten_custom_excerpt_length', 999 );

function kindergarten_new_excerpt_more( $more ) {
  return '...';
}
add_filter('excerpt_more', 'kindergarten_new_excerpt_more');